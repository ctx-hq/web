...
export const PackageStatsPage: FC<{
  ...
  <Container class="py-8">
    ...
    <h1 class="mb-6 text-base font-semibold font-heading">{fullName} &mdash; Stats</h1>

    {/* Summary cards */}
    <div class="mb-8 grid gap-3 sm:grid-cols-3">
      <div class="cn-card p-4">
        <dt class="mb-1 text-[10px] text-muted-foreground">Total Downloads</dt>
        <dd class="text-lg font-semibold font-heading">{formatNumber(stats.downloads.total)}</dd>
      </div>
      <div class="cn-card p-4">
        <dt class="mb-1 text-[10px] text-muted-foreground">Weekly Downloads</dt>
        <dd class="text-lg font-semibold font-heading">{formatNumber(stats.downloads.weekly)}</dd>
      </div>
      <div class="cn-card p-4">
        <dt class="mb-1 text-[10px] text-muted-foreground">Agent Installs</dt>
    ...
    <div class="lg:flex lg:gap-8">
      ...
      <section class="min-w-0 flex-1 mb-8 lg:mb-0">
        <h2 class="mb-4 text-xs font-semibold font-heading">Daily Downloads</h2>
        {stats.downloads.daily.length === 0 ? (
          <p class="text-xs text-muted-foreground">No daily data available.</p>
        ) : (
          <div class="cn-card p-4">
      ...
      <aside class="w-full lg:w-72 lg:shrink-0">
        <h2 class="mb-4 text-xs font-semibold font-heading">Agent Breakdown</h2>
        <div class="cn-card p-4">
